      ...
      <Popover
        ...
        className={({ open }) =>
          classNames(
            ...
            'bg-oscuro shadow-2xl shadow-oscuro-plus lg:static lg:overflow-y-visible'
          )
        }
      >
        {({ open }) => (
          <>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-40">
              <div className="relative flex justify-between xl:grid xl:grid-cols-12 lg:gap-8">
                ...
                <div className="hidden lg:flex lg:items-center lg:justify-center xl:col-span-4">
                  <NavLink to="/create"
                  className="text-gray-400 hover:text-gray-200 text-lg font-medium"
                  ...
                  <Menu as="div" className="flex-shrink-0 relative ml-16">
                    ...
                    >
                      <Menu.Items className="origin-top-right absolute z-10 right-0 mt-2 w-auto rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 py-1 focus:outline-none">
