const Banner=()=>{
    return(
        <div className="bg-oscuro mt-14">
            <div className="grid md:grid-cols-2">
                <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                    <div className="text-center">
                        <p className="mt-1 text-4xl font-medium text-gray-300 sm:text-5xl sm:tracking-tight lg:text-6xl">
                ...
                <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                    <img src="octans.png" alt="" className="h-full w-full"/>
                </div>
